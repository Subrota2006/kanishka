 ...
 let canvas = document.getElementById('stage');
  ...
  if(value=="kanishka1"){
    console.log("User entered kanishka1");
    const myImage = document.getElementById("myImage");
    const imageUrl = `c:\Users\Nandita\Downloads\impressingCrush-main\impressingCrush-main\images\12.jpeg`;
  ...
  if(value=="kanishka2"){
    ...
    console.log("User entered kanishka2");
    const myImage = document.getElementById("myImage");
    const imageUrl = `c:\Users\Nandita\Downloads\impressingCrush-main\impressingCrush-main\images\WhatsApp Image 2024-09-10 at 12.08.34 AM (1).jpeg`;
    const hoverUrl = "https://m.media-amazon.com/images/I/61fagD4zWKL.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
  ...
  if(value=="kaishka3"){
    console.log("User entered kanishka3");
    const myImage = document.getElementById("myImage");
    const imageUrl = `c:\Users\Nandita\Downloads\impressingCrush-main\impressingCrush-main\images\wpphoto.JPG`;
    const hoverUrl = "https://m.media-amazon.com/images/I/61fagD4zWKL.jpg";
    myImage.setAttribute("src", imageUrl);
    myImage.setAttribute("data-hover", hoverUrl);
    new Scene();
